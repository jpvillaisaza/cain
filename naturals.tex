...
\epigraph{
  ... and \term{functor} has been defined in order to be able to
  define \term{natural transformation}.
...
\todo{Introduce Definition \ref{def:natural}. Consider including
  Remark \ref{re:natural}.}
...
\begin{definition}
  ...
  \index{transformation!natural ---|see{natural transformation}}
  ...
  \begin{equation*}
    ...
    \text{,}
  \end{equation*}
  called a \term{component} of the natural transformation, such that,
  ...
  \begin{equation}
    ...
    \text{,}
  \end{equation}
  called \term{naturality} of the natural transformation, that is,
...
\begin{remark}
  ...
  a picture of all the objects and morphisms of \cat{C} in \cat{D}
  (see Remark \ref{re:functor-picture}), a natural transformation
  $\nat{\tau}: \func{F} \to \func{G}: \cat{C} \to \cat{D}$ may be
  thought of as a mapping or translation from the picture \func{F}
  into the picture \func{G} with all diagrams like that of Figure
...
\begin{remark}
  [Why is a natural transformation \emph{natural}?]
...
\begin{definition}
  ...
  \index{isomorphism!natural ---|see{natural isomorphism}}
...
Although Definition \ref{def:natural-isomorphism} is not an essential
...
\todo{Introduce examples of natural transformations.}
...
\begin{example}
  [Identity and power set\footnote{This example is based on
  ...
  \begin{proof}
    ...
    \begin{steps}
      ...
      \step{$\natO{\eta}{Y}(\funcM{I}(f)(x))$}
        \eqbydef{\funcM{I} \eqref{eq:funcM-id-b}}
      \step{$\natO{\eta}{Y}(f(x))$}
        \eqbydef{\nat{\eta} \eqref{eq:eta}}
      \step{$\{f(x)\}$}
        \eqbydef{\funcM{P} \eqref{eq:funcM-power-set}}
      \step{$\funcM{P}(f)(\{x\})$}
        \eqbydef{\nat{\eta} \eqref{eq:eta}}
      \step{$\funcM{P}(f)(\natO{\eta}{X}(x))$}
        \eqbydef{\comp}
...
\index{polymorphism!parametric ---|see{parametric polymorphism}}
...
\index{parametricity}\emph{parametricity} due to its relation with
...
\begin{remark}
  [Natural isomorphisms in Haskell]

  Given two functors \texthaskell{f} and \texthaskell{g}, a natural
