...
function can be defined as follows\footnote{Note that this is not the
  type signature of the standard \texthaskell{foldr} function.}:
\begin{codehaskell}
foldr :: b -> (a -> b -> b) -> [a] -> b
foldr n c []     = n
...
with \texthaskell{c}. This amounts to saying that both triples
...
definition of the \texthaskell{foldr} function.
...
\begin{definition}
  ...
  \cat{C}. An \func{F}-algebra $(a,\alpha)$ is an object $a \in
  \catO{C}$, called the carrier of the algebra, and a morphism
...
\begin{example}
  ...
  \set$ whose object function $\funcO{N}: \catO\set \to \catO\set$
...
\begin{example}
  ...
  whose object function $\funcO{L}^{A}: \catO{\set} \to \catO{\set}$
  assigns to each set $B$ a set
  \begin{equation*}
...
\begin{definition}
  ...
  morphism $f: a \to b \in \catM{C}$ such that
  \begin{equation}
...
\begin{definition}
  ...
  \begin{proof}
    ...
    We prove \eqref{eq:algebra-homomorphism} with $f =
    \idO{(a,\alpha)}$:
    \begin{steps}
...
\begin{definition}
  ...
  \begin{proof}
    ...
    We prove \eqref{eq:algebra-homomorphism} with $f = g \comp f$:
    \begin{steps}
...
\begin{definition}
  ...
  \func{F}-algebras $(a,\alpha)$, there is a unique \func{F}-algebra
  homomorphism $\cata\alpha: (\mu\func{F},\inmo) \to (a,\alpha)$, that
  is, a morphism $\cata\alpha: \mu\func{F} \to a \in \catM{C}$ such
  that
  \begin{equation}
    \label{eq:cata-charn}
