...
\begin{definition}
  ...
  $\cat{C}$. An \func{F}-algebra $(a,\alpha)$ is an object $a$, called
...
\begin{example}
  ...
  \ref{ex:functor-identity}), that is, an \func{I}-algebra. In
...
\begin{definition}
  ...
  $\cat{C}$. In order to see that this is an \func{F}-algebra
...
\begin{definition}
  ...
  \func{F}-algebra homomorphism, we prove
...
\begin{definition}
  ...
  commutative. Such an \func{F}-algebra homomorphism (that is, a
